...
if __name__ == '__main__':
    ...
    hyper_params = {
        ...
        "env": "ALE/Pong-v5",  # "PongNoFrameskip-v4",  # name of the game
        # "env": "ALE/Breakout-v5", # "PongNoFrameskip-v4",  # name of the game
        # "env": "ALE/Pong-v5",  # "PongNoFrameskip-v4",  # name of the game
    ...
    for t in range(hyper_params["num-steps"]):
        ...
        if done and hyper_params["print-freq"] is not None and len(episode_rewards) % hyper_params[
            ...
            print("NNNNNNNNNN", num_episodes)
            print("RRRRRRRRRR", episode_rewards)
