...
# Hidden Layers
tf_weights_1 = tf.compat.v1.get_variable("tf_weights_1", [tf_input_size, tf_hidden_layer_size],
...
learning_rate = 0.1  # 0.8  # Learning rate
max_steps = 100  # 99  # Max steps per episode
gamma = 0.99  # 0.95  # Discounting rate

# Exploration parameters
epsilon = 1.0  # Exploration rate
max_epsilon = 1.0  # Exploration probability at start
min_epsilon = 0.01  # Minimum exploration probability
decay_rate = 0.001  # 0.005  # Exponential decay rate for exploration prob
