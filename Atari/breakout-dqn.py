...
"""
funkt für space invaders - keine prints
funkt für breakout aber es werden keine episoden in der konsole angezeigt
funkt für pong - keine prints
"""
...
# env = gym.make('ALE/SpaceInvaders-v5', render_mode='human')  # create our environment
    # RuntimeError: mat1 and mat2 shapes cannot be multiplied (1075200x3 and 100800x64)
